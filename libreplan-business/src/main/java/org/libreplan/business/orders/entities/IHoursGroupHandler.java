...
public interface IHoursGroupHandler<T> {
   ...
   *
   * @param hoursGroups A {@link HoursGroup} set
   ...
   *
   * @param workHours The desired value to set as total working hours
   * @throws IllegalArgumentException If parameter is less than 0 or if it's not possible to set
